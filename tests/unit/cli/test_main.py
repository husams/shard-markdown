...
class TestCLIMain:
    ...
    def test_cli_with_config_file(self, mock_setup_logging, mock_load_config, 
                                  cli_runner, config_file):
...
class TestCLILogging:
    ...
    @patch('shard_markdown.cli.main.setup_logging')
    @patch('shard_markdown.cli.main.load_config')
    def test_logging_setup_quiet_mode(self, mock_load_config, mock_setup_logging, cli_runner):
    ...
    @patch('shard_markdown.cli.main.setup_logging')
    @patch('shard_markdown.cli.main.load_config')
    def test_logging_setup_verbose_mode(self, mock_load_config, mock_setup_logging, cli_runner):
    ...
    @patch('shard_markdown.cli.main.setup_logging')
    @patch('shard_markdown.cli.main.load_config')
    def test_logging_setup_custom_log_file(self, mock_load_config, mock_setup_logging, 
                                          cli_runner, temp_dir):
...
class TestCLIErrorHandling:
    ...
    @patch('shard_markdown.cli.main.setup_logging')
    @patch('shard_markdown.cli.main.load_config')
    def test_logging_error_handling(self, mock_load_config, mock_setup_logging, cli_runner):
    ...
    def test_nonexistent_config_file(self, cli_runner):
        ...
        assert "No such file" in result.output or result.exit_code == 0  # Depending on implementation
