...
from shard_markdown.config.settings import AppConfig, ChromaDBConfig, ChunkingConfig, ProcessingConfig
    ...
    def test_nested_validation(self):
        ...
        with pytest.raises(ValidationError):
            AppConfig(
                ...
                chunking=ChunkingConfig(default_size=500, default_overlap=600)  # Overlap > size
            )
