...
class ChromaDBOperations:
    ...
    def query_collection(self, collection_name: str, query_text: str,
        ...
        try:
            ...
            logger.info(f"Query returned {len(processed_results['results'])} results from '{collection_name}'")
    ...
    def list_documents(self, collection_name: str, limit: int = 100,
                      offset: int = 0, include_metadata: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Listed {len(documents)} documents from '{collection_name}' (total: {total_count})")
    ...
    def _process_query_results(self, results: Dict, similarity_threshold: float,
